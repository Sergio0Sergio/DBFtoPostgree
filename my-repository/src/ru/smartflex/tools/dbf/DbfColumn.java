...
public class DbfColumn {
	 ...
	 *            column width
	 * @param dec
	 *            column scale ( in other words amount point after comma )
	 * @since 1.00
	 */
	...
	protected void parse(byte[] recField) {
		...
		/*
		 * Foxpro makes bad this field after dbf modify int offset =
		 * recField[12] & 0xff; offset += (recField[13] & 0xff) << 8; offset +=
		 * (recField[14] & 0xff) << 16; offset += (recField[15] & 0xff) << 24;
		 */
